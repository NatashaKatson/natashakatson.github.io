...
The main landing page is a custom static template at `/layouts/index.html`. Most other site content is generated by Hugo from Markdown files under `/content/`.
...
- Most pages and post content are sourced from Markdown and rendered by Hugo
- All posts require both English and Russian versions for full bilingual support

### Customizations Over Theme

- `/layouts/index.html` - Main landing page; a custom pre-built HTML template with hero section, expertise areas, and interests grid
